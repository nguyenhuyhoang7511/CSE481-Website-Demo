    ...
    <div class="container mt-3">
        <div class="main_header">
            ...
            <div class="main_header_search ms-3 me-3" style="flex-basis: 40%;">
                <form action="" method="post" name="myForm" style="display: flex" onsubmit="return validateForm()">
                    <input type="text" name="search" placeholder="Bạn muốn tìm kiếm sản phẩm nào ?" style="width: 100%;">
        ...
        <div class="container">
            <div class="container mt-5 justify-content-between" style="box-sizing: content-box">
                <div class="row">
                    ...
                    ?>
                        <?php
                        $query = mysqli_query($conn, "SELECT * FROM `db_thongtintour` WHERE `loai_tour` LIKE '%$keyword%' ");
                        while ($fetch = mysqli_fetch_array($query)) {
                            $id_tour = $fetch['ma_tour'];

                        ?>
                            <p class="text-danger">Kết quả tìm kiếm :</p>
                            ...
                            <div class="col-md-3">
                                <div class="card" style="width: 19rem;">
                                    ...
                                    <?php } ?> -->
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo $fetch['loai_tour'] ?></h5>
                                        <!-- $id_tour = ; -->

                                        <p class="card-text"><?php echo $fetch['mo_ta'] ?></p>
                                        <div class="d-flex justify-content-between">
                                            <span class="text-decoration-underline" style=" font-weight: 600; color: crimson;"><?php echo $fetch['gia_tour'] ?><sup>đ</sup></span>
            ...
            <script>
                function validateForm() {
                    ...
                    if (x == "") {
                        alert("Dữ liệu đang được để trống hoặc không tồn tại !!");
                        return false;
                    }
                }
            </script>
