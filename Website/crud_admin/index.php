<?php
 ...
 <body>
      <br /><br />
      <div class="container">
           <h3 class="text-center " style="font-size: 40px; font-weight: 700;"> <i class="bi bi-stack-overflow"></i> ADMIN 2HAND STORE</h3>

           <br />
           <div class="table-responsive">
                <div class="right">
                     <button type="button" name="add" id="add" data-toggle="modal" data-target="#add_data_Modal" class="btn btn-warning"><i class="bi bi-plus-circle"></i> Thêm Sản Phẩm</button>
                ...
                <div class="">
                     <div class="modal-content">
                          <div class="modal-header">
                               ...
                               <h4 class="modal-title fs-1">Thông tin chi tiết của Sản Phẩm</h4>
                          </div>
