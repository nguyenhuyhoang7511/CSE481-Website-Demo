<?php
    ...
    function sendEmailForAccountActive($email,$link)
    {
        ...
        try {
            ...
            $mail->Subject = '[2Hand Store] KÍCH HOẠT TÀI KHOẢN'; // tiêu đề thư
            $mail->Body    = 'Chào mừng bạn đến với 2Hand Store <3 <br> Để sử dụng tài khoản, ' . $link . 'để kích hoạt'; // Nội dung thư
